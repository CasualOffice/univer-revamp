    ...
    'sheets-data-validation': {
        ...
        time: {
            operators: {
                ...
                legal: 'is a legal time',
            },
            ruleName: {
                between: 'is between {FORMULA1} and {FORMULA2}',
                greaterThan: 'is after {FORMULA1}',
                greaterThanOrEqual: 'is at or after {FORMULA1}',
                lessThan: 'is before {FORMULA1}',
                lessThanOrEqual: 'is at or before {FORMULA1}',
                equal: 'is {FORMULA1}',
            ...
            errorMsg: {
                between: 'Value must be a legal time and between {FORMULA1} and {FORMULA2}',
                greaterThan: 'Value must be a legal time and after {FORMULA1}',
                greaterThanOrEqual: 'Value must be a legal time and at or after {FORMULA1}',
                lessThan: 'Value must be a legal time and before {FORMULA1}',
                lessThanOrEqual: 'Value must be a legal time and at or before {FORMULA1}',
                equal: 'Value must be a legal time and {FORMULA1}',
                notEqual: 'Value must be a legal time and not {FORMULA1}',
                notBetween: 'Value must be a legal time and not between {FORMULA1}',
                legal: 'Value must be a legal time',
            },
            title: 'Time',
        },
        textLength: {
        ...
        validFail: {
            ...
            time: 'Please input time or formula',
